...
class Client {
  ...
  /**
	 ...
	 * 创建Service
	 * 
	 * Options: - description Service的简短描述 - logConfig log config - role Service
	 * role
	 * 
	 * @param {String}
	 *            serviceName 服务名
  ...
  /**
	 * 创建Function
	 * 
	 * Options: - description function的简短描述 - code function代码 - functionName -
  ...
  /**
	 ...
	 *            functionName
	 * @param {Object}
	 *            options Function配置，见createFunction
	 * @return {Promise} 返回 Object(包含headers和data属性[Function信息])
	 */
  ...
  /**
	 ...
	 *            triggerName
	 * @param {Object}
	 *            options Trigger配置，见createTrigger
	 * @param {Object}
	 *            headers
	 * @return {Promise} 返回 Object(包含headers和data属性[Trigger信息])
	 */
